...
ActiveRecord::Schema.define(version: 2021_01_01_051054) do
  ...
  create_table "leavereuests", force: :cascade do |t|
    t.string "startdate"
    t.string "enddate"
    t.string "status"
    t.datetime "created_at", precision: 6, null: false
    ...
    t.string "reason"
    t.bigint "user_id", null: false
    t.index ["user_id"], name: "index_leavereuests_on_user_id"
  end
  ...
  create_table "quotes", force: :cascade do |t|
    ...
    t.index ["quotation_id"], name: "index_quotes_on_quotation_id"
  end
  ...
  add_foreign_key "leavereuests", "users"
  add_foreign_key "logs", "users"
  add_foreign_key "quotes", "quotations"
